...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-maldirppa-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8007&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-maldirppa-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-maldirppa` can be installed with:

```
conda install r-maldirppa
```

It is possible to list all of the versions of `r-maldirppa` available on your platform with:
